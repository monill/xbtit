...
$language['EMAIL_FAILED']='El envio del email falló!';
$language['NO_SUBJECT']='Sin asunto';
$language['MUST_ENTER_PASSWORD']='<br /><font color="#FF0000"><strong>Debes poner tu contraseña para realizar los cambios.</strong></font>';
