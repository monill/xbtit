<?php
$language['ERR_NO_EMAIL']='আপনার সঠিক ইমেইল ঠিকানা দিতে হবে';
$language['ERR_INV_EMAIL']='আপনার সঠিক ইমেইল ঠিকানা দিতে হবে';
$language['ERR_NO_CAPTCHA']='ছবির কোড সঠিক ভাবে লিখতে হবে';
$language['IMAGE_CODE']='ছবির কোড';
$language['SECURITY_CODE']='প্রশ্নের উত্তর দিন';
